...
Usage
─────
  # Full run (scoring + pruning + eval at 30/50/70%)
  python run_dcd.py

  # Only compute and cache DCD scores (no pruning)
  python run_dcd.py --step scores_only

  # Load cached scores, prune and eval only
  python run_dcd.py --step prune_only

  # Just strategy A (weight criterion)
  python run_dcd.py --strategy A

  # Just strategy B (layer budget)
  python run_dcd.py --strategy B

  # Override sparsity list
  python run_dcd.py --sparsity 0.5 0.7

  # Override model
  python run_dcd.py --model meta-llama/Llama-3.2-3B-Instruct
